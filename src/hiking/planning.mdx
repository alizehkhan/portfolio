...
_Planning your first long distance hike can be an intimidatingly long process but after completing the first one you'll find it's significantly easier to plan your next adventures. After a couple of years of hiking, I've figured out my own rhythm when planning a multi-day hike so I thought I'd share my process in case it helps anyone out, new or experienced._
...
- **What's the weather like?** Is there a lot of snow / rain I need to prepare or carry extra gear for like micro spikes or an ice axe?

- **Is the trail at least 10 days long?** I opt for hikes that are at least this long as I get to really connect with myself and nature.
...
<div className="flex flex-wrap gap-2">
	...
	/>
	<AppCard image="/assets/mapsme.png" name="maps.me" link="https://maps.me/" />
</div>
...
I google the trail's GPX file, download it and import it to **GAIA GPS**. I'll use GAIA GPS's mobile app as my main source of navigation. Their map is just beautiful for hiking. I can see the elevation profile, water sources, campsites, bivouacs, cabanes, grocery shops and other points of interest. I can also view all this in 3D mode, which makes it much easier to get a visual of a section.

The recommended stages are usually designed for hut-to-hut hiking where you end the day at a refuge that you need to have booked in advance. I like to carry my own food and shelter and go with the flow when I'm out there so I'll instead prepare for this by pinning the campsites, bivouacs and cabanes along the way. Then the night before I set off for a section, I would have a look at the map and choose a sensible spot to end of the day at. I'd also have a look for water sources coming up that day and if there's a dry section, I can be prepared.

When I pass by a town I might also use **maps.me**'s offline maps for points of interest such as grocery shops, ATMs, pharmacy’s etc. I'll download the trail in a KML format, send this file to myself on WhatsApp and open it on mobile using maps.me. When I do this, I will find the map and any points under my bookmarks on the app.

![Camping in the Alps](/assets/camping.png)

## 3. Pick dates and book transport

<div className="flex flex-wrap gap-2">
	<AppCard
		image="/assets/skyscanner.png"
		name="Skyscanner"
	...
	<AppCard
		image="/assets/db.png"
		name="DB Navigator"
		link="https://www.bahn.de/service/mobile/db-navigator"
	/>
	<AppCard
		image="/assets/interrail.png"
		name="Interrail"
		link="https://www.interrail.eu/de/interrail-passes/global-pass"
	/>
	<AppCard image="/assets/gcal.png" name="Google Calendar" />
	<AppCard image="/assets/flo.png" name="Flo" link="https://flo.health/" />
</div>
...
- I research the nearest, most accessible airport or train station to the hike. If it's a popular hike this is usually well documented in blogs.
...
<div className="flex flex-wrap gap-2">
	<AppCard
		image="/assets/truetraveller.png"
		name="True Traveller"
		link="https://www.truetraveller.com/"
	/>
	<AppCard
		image="/assets/dav.jpg"
		name="DAV"
		link="https://www.alpenverein.de/verband/dav-mitglied-werden"
	/>
</div>

Anything can happen out there on the mountain.

As a European resident I am covered for medical emergencies within the EU with my EHIC. However, this does not include mountain rescue. I usually purchase the most basic traveller insurance plan from **True Traveller** which covers helicopter rescue/air ambulance charges when hiking up to 3000m.

There's also the option to purchase an annual membership (~80–100€) with an Alpine club such as **DAV** (German) and **AACUK** (UK). The membership includes mountain rescues in Europe as well as discounts for Alpine associated cabins. You don't need to be a resident in the country of the Alpine Club you sign up with although it's nice to be as they also host events and offer local benefits and mountaineering courses etc.

## 5. Book first night accommodation
...
## 6. Plan transport to trail head & first day errands
...
⛽️ If travelling via plane, I am unable to take a can of pressurised gas with me so I'll do a quick check of some hiking stores I could buy a **screw top cartridge of fuel** from at the starting town. I check this using maps.me or ask on the trail's facebook group.

🗺️ I'll also buy a mini **compact map** of the trail from a hiking store as my back up navigation.

💶 Lastly, I will take out **cash** from an ATM before setting off. I will use my card where possible and keep cash as a backup. How much will depend on where the hike is, when I'll see another ATM machine etc.
...
I keep an [up-to-date list of my gear](/hiking/gear) along with info on how I use them here if you're interested. I used **Airtable** to record all this info.

## 8. Train

In general, I train ~5 times a week at my local CrossFit box. CrossFit is a combination of weightlifting, endurance and gymnastics, so very all rounded.

However, I've learnt the hard way that CrossFit predominantly focuses on strengthening the larger muscles and not the small stabilising muscles we also need when hiking. So I've now incorporated exercises to strengthen my gluteus medius and minimus which provide stability and assistance to the rotation of my hips. There are also a series of stretches I do whilst out on the trail. I've learnt all these hiking specific stretches and exercises from the legendary [Chase Mountains](https://www.youtube.com/watch?v=WQauQv4uDLs).

He also did a video on how to fix [IT band syndrome](https://www.youtube.com/watch?v=bGsOfRH4UEI) on trail, which has been a lifesaver for me. It's something I suffered with on trail before and it sucks (a lot!). Especially if, like me, you didn't know what you had at the time and thought it was knee pain.

It's important I listen to my body during these trips.

![CrossFit](/assets/crossfit.png)

---

_And that's everything, the rest I prefer to wing along the way and go with the flow!_
