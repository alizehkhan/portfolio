												...
												>
													...
													<div className="divide-grey-200 divide-y rounded-lg p-4">
														{items.map((gearItem) => (
															<Link
																key={gearItem.id}
																className="flex w-full grid-cols-[100px_240px_1fr_auto_60px] flex-col items-center gap-1 py-1.5 md:grid md:gap-4"
																to={gearItem.id}
															>
																<div className="w-fit rounded bg-white px-2 py-1">
																	<img
																		...
																		alt=""
																		className="w-36 object-contain md:h-12 md:w-16"
																	/>
																</div>
