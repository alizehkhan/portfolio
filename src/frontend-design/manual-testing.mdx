...
_If you've never used the screen reader on your Mac, my hope is that by the end of this post you will have at least pressed <Key>command</Key> + <Key>F5</Key>. I mean you could even press it now if you want 🤷._
...
<Key>↑</Key>/<Key>↓</Key>/<Key>←</Key>/<Key>→</Key> to cycle through related
...
<Key>command</Key> + <Key>F5</Key> to activate MacOS's built-in screen reader,
Voiceover.

<Key>control</Key> + <Key>option</Key> + <Key>←</Key>/<Key>→</Key> to move
between elements
