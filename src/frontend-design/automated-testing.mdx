...
_We can leverage tooling and automated tests during our development workflow to help us:_

- _uncover "low-hanging fruit" type accessibility issues,_
- _develop accessible components more efficiently,_
- _improve test coverage, and_
- _avoid introducing technical debt._
