...
If your users are often asking questions already answered in the documentation, then your documentation is probably shit 💩. **Yes, documentation needs content designing too.** Just because the information is there, doesn't mean it's been presented in a way that's easily digestible, clear and in the format needed for your users. There is also such a thing as too much documentation. Reduce the content! **What is actually used and needed here?** Good design is about managing attention.

Engineers are wonderfully lazy 🦥 but smart people. They'll do everything they can before they have to leave their IDE to read documentation. Having to do this often breaks their flow. **Good design is first intuitive then discoverable**. Meaning, you want to name and design your APIs and tokens as intuitively as possible so your engineers don't have to leave their IDEs to refer to the documentation. Please don't band aid bad component API design with more documentation for the component, prioritise the API.

Some best practice on component API design include:
