...
- I sometimes ask for recommendations on the hiking groups I'm a member of on Facebook. The hiking community is awesome. We love sharing each others adventures and learnings. Here are a couple I'm a part of: [GR10, GR11 and HRP](), [GR54](https://www.facebook.com/groups/EcrinsGR54), [Walker's Haute Route](), [Long Distance Hiking in Europe](https://www.facebook.com/groups/1758402431125086).
...
AllTrails is my favourite tool for this. Most popular trails come as a `List` with all the stages mapped out. I can see the elevation profile of a trail and when I close up I can also see water sources, campsites, bivouacs and cabanes.

The recommended stages are usually designed for hut-to-hut hiking where you end the day at a refuge you'd need to book in advance. I like to carry my own food and shelter and go with the flow when I'm out there so I'll instead prepare for this by make a copy of the full trail and pinning the campsites, bivouacs and cabanes along the way. Then the night before I set off for a section, I'd have a look at the map and choose a sensible spot to end of the day at. I'd also have a look for water sources coming up for the day if there's a dry section, I can be prepared.

With AllTrails+, I can then download this "custom" map of the trail with my pinned points to use offline on my phone as my main source of navigation on trail. I can also switch to 3D mode!
...
- I'll figure out how many days the hike will roughly take me. I'll add a day for arrival and another for departure. I'll may also add an extra day for contingency, depending on the difficulty of the hike.
...
- I then find a suitable slot in the month to fit my hike in and block the dates in my Google Calendar. I use Flo to help me find a window of time I won't be on my period and Skyscanner to check out flight prices. Tuesday is always the cheapest day of the week to fly.
