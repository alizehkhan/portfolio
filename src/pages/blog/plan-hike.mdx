...
I research the trail's GPX file, download it and import it to **GAIA GPS**. I'll use GAIA GPS's mobile app as my main source of navigation. Their map is just beautiful for hiking. I can see the elevation profile, water sources, campsites, bivouacs, cabanes and grocery shops and other points of interest. I can also view all this in 3D mode, which makes it much easier to get a visual of a section.
