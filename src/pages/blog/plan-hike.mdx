...
<div className='flex flex-wrap gap-2'>
  <AppCard image='/assets/gaia.png' name='GAIA GPS' link='https://www.gaiagps.com/' />
...
<div className='flex flex-wrap gap-2'>
  <AppCard image='/assets/skyscanner.png' name='Skyscanner' link='https://www.skyscanner.com/' />
  <AppCard image='/assets/db.png' name='DB Navigator' link='https://www.bahn.de/service/mobile/db-navigator' />
  <AppCard image='/assets/interrail.png' name='Interrail' link='https://www.interrail.eu/de/interrail-passes/global-pass' />
...
<div className='flex flex-wrap gap-2'>
  <AppCard image='/assets/truetraveller.png' name='True Traveller' link='https://www.truetraveller.com/' />
  <AppCard image='/assets/dav.jpg' name='DAV' link='https://www.alpenverein.de/verband/dav-mitglied-werden' />
</div>
...
<AppCard image='/assets/airtable.png' name='Airtable' link='https://airtable.com' />
